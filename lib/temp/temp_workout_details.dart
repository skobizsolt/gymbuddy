...
class TempWorkoutDetails extends StatelessWidget {
  const TempWorkoutDetails(
      {super.key, required this.workout, required this.steps});
  ...
  Widget build(BuildContext context) {
    ...
    Widget renderTags() {
      var tags = [
        InformationTag(
          child: Text(
            '${workoutCategoryIcon[WorkoutCategory.values.byName(workout.category!.name)]} ${workout.category!.name[0].toUpperCase() + workout.category!.name.substring(1)}',
        ...
        InformationTag(
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              workoutDifficultyRating[WorkoutDifficulty.values
                  .byName(workout.difficulty!.name)] as Widget,
              const SizedBox(
                width: 5,
              ),
              Text(
    ...
    return DribbleLayout(
      ...
      headerContent: Column(
        children: [
          ...
          // Time to complete
          renderDetail(
            title: '${workout.stepDetails!.estimatedTimeInMinutes} mins',
            icon: Icons.access_time_rounded,
          ),

          // Steps
          renderDetail(
              title: '${workout.stepDetails!.totalSteps} Steps',
